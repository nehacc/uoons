import React2, { useRef, useState, useCallback, useEffect } from 'react';
...
var EasyZoomOnHover = React2.forwardRef(function EasyZoomOnHover2(props, ref) {
  ...
  const imageHoverContainerRef = React2.useRef(null);
  const zoomTargetRef = React2.useRef(null);
  const imgRef = React2.useRef(null);
  const [imageDimension, setImageDimensions] = React2.useState({ height: 0, width: 0 });
  const [isImageLoaded, setIsImageLoaded] = React2.useState(false);
  ...
  return /* @__PURE__ */ React2.createElement(React2.Fragment, null, !isImageLoaded && (loadingIndicator ?? /* @__PURE__ */ React2.createElement(
    Skeleton_default,
    {
...
var EasyZoomOnMove = (props) => {
  ...
  const imageMoveContainerRef = React2.useRef(null);
  const imgRef = React2.useRef(null);
  const [imageDimension, setImageDimensions] = React2.useState({ height: 0, width: 0 });
  const delay = (ms) => new Promise((resolve) => setTimeout(resolve, ms));
  React2.useEffect(() => {
