...
const Homepage = () => {
  ...
  // Check if HomePageData and HomePageData.Data exist and have the required structure
  const isDataValid = (data, indices) => {
    return data && data.Data && indices.every(index => data.Data[index] && data.Data[index].items);
  };
