...
import { FiMenu, FiHome, FiUsers, FiInbox, FiLock, FiShoppingBag } from 'react-icons/fi';
...
const NewProfile = () => {
  return (
    <div className='p-6 bg-white'>
      ...
      <aside
        id="default-sidebar"
        className="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0 p-6"
        aria-label="Sidebar"
      >
          ...
          <ul className="space-y-2 font-medium">
            ...
            <li>
              <a
                ...
                className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700"
              >
                <FiLock className="w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" />
