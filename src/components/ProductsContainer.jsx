...
//               >
//                 <button id="like" className="absolute p-2 rounded-full text-lg bg-blue-50 right-[16px] top-[-40px] hover:top-[10px] duration-500 shadow-2xl border text-gray-600 hover:text-red-500"><IoMdHeart /></button>
//                 <img
...
//                   <h3 id="title" className="font-semibold text-lg h-[55px] overflow-hidden text-center">
//                     {item.product_name}
//                   </h3>
//                   <div className="flex items-center gap-1 text-yellow-500">
//                     <span>4</span>
...
//                   <a href="#_" class="relative rounded px-2 overflow-hidden group bg-orange-500 hover:bg-gradient-to-r hover:from-orange-500 hover:to-orange-400 text-white hover:ring-2 hover:ring-offset-2 hover:ring-orange-400 transition-all ease-out duration-300">
//                     <span class="absolute right-0 w-8 h-32 -mt-12 transition-all duration-1000 transform translate-x-12 bg-white opacity-10 rotate-12 group-hover:-translate-x-40 ease"></span>
//                     <span class="relative text-sm">BUY NOW</span>
//                   </a>

//                   <a href="#_" class="relative flex items-center justify-center rounded px-2 overflow-hidden group bg-orange-500 hover:bg-gradient-to-r hover:from-orange-500 hover:to-orange-400 text-white hover:ring-2 hover:ring-offset-2 hover:ring-orange-400 transition-all ease-out duration-300">
//                     <span class="absolute right-0 w-8 h-32 -mt-12 transition-all duration-1000 transform translate-x-12 bg-white opacity-10 rotate-12 group-hover:-translate-x-40 ease"></span>
//                     <span class="relative text-xl flex items-center"><MdAddShoppingCart /></span>
//                   </a>
...
const ProductsContainer = (props) => {
  ...
  const addToWishlist = async (pid) => {
      try {
        ...
        alert("Added to wishlist, item with pid "+ pid)
      } catch (err) {
        setError(err);
      }
